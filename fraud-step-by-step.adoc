...
To deploy the full demo please SSH to your cluster host 
...
The transaction data is described by the schema in file `link:https://gist.githubusercontent.com/asdaraujo/e680557100b82d5e0004d7b9f4e3b4f7/raw/f7192cb27e61035fa26156881980342bf385fd2f/transaction.avsc`. In this lab we will register this schema in Schema Registry so that our flows in NiFi can refer to schema using an unified service. This will also allow us to evolve the schema in the future, if needed, keeping older versions under version control, so that existing flows and flowfiles will continue to work.
...
+
`link:https://gist.githubusercontent.com/asdaraujo/e680557100b82d5e0004d7b9f4e3b4f7/raw/f7192cb27e61035fa26156881980342bf385fd2f/transaction.avsc, window="_blank"]`
...
[source,shell]
----
/tmp/resources/reset-to-lab.sh fraud 1
----
...
+
`link:./customers_temp.csv, window="_blank"]`
...
[[lab_11, Lab 11]]
== Lab 10 - Import DataViz visual and observe the dashboard
