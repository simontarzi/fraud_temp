...
+
image::images/fraud/lab4_nifi9_uploadgenerators.png[width=auto]

+
You will see the following warnings, these are because it is requiring a StandardHttPContextMap Controller:

image::images/fraud/lab4_nifi10_generators.png[width=800]
...
+
image::images/fraud/lab4_nifi12_updateattribute.png
