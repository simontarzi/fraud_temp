...
. On the HUE UI navigate to the left pane and open "Importer" and download the customers_temp.csv from the git and drag&drop it to the importer UI.

+
file::customers_temp.csv

+
[link](./customers_temp.csv)
...
+
link: ./customers_temp.csv[customers_temp.csv]
